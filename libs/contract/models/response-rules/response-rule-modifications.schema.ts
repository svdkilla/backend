...
import { HttpResponseHeaderEntrySchema } from '../http-response-headers.schema';
...
export const ResponseRuleModificationsSchema = z
    .object({
        headers: z
            .array(
                HttpResponseHeaderEntrySchema.describe(
                    JSON.stringify({
                        markdownDescription:
        ...
        additionalExtendedClientsRegex: z
            .array(
                z
                    ...
                    .min(1)
                    .max(128)
                    .refine(isSafePublicHeaderRegex, 'Regex is unsafe for public header matching'),
            )
            .max(20)
            .optional()
            .describe(
